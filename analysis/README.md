...
Analyze serverless apps for each language to generate least-privilege policies and statistics.
...
Analyzes the least-privilege policies generated by the PrivLess pipeline and compares them against defaults.
